...
<qgis minScale="1000000" autoRefreshMode="Disabled" maxScale="0" labelsEnabled="0" simplifyDrawingHints="1" hasScaleBasedVisibilityFlag="1" version="3.44.8-Solothurn" autoRefreshTime="0" simplifyLocal="1" styleCategories="AllStyleCategories" simplifyDrawingTol="1" simplifyMaxScale="1" readOnly="0" symbologyReferenceScale="-1" simplifyAlgorithm="0">
 ...
 <elevation binding="Centroid" zoffset="0" zscale="1" clamping="Terrain" symbology="Line" extrusionEnabled="0" type="IndividualFeatures" customToleranceEnabled="0" extrusion="0" respectLayerSymbol="1" showMarkerSymbolInSurfacePlots="0">
  ...
  <profileLineSymbol>
   <symbol is_animated="0" frame_rate="10" type="line" alpha="1" clip_to_extent="1" force_rhr="0" name="">
    ...
    <layer enabled="1" pass="0" id="{780c010e-326b-4743-9aa3-4d97f4b27434}" locked="0" class="SimpleLine">
     <Option type="Map">
  ...
  <profileFillSymbol>
   <symbol is_animated="0" frame_rate="10" type="fill" alpha="1" clip_to_extent="1" force_rhr="0" name="">
    ...
    <layer enabled="1" pass="0" id="{778faa48-aed8-49af-9967-012e2d34ca15}" locked="0" class="SimpleFill">
     <Option type="Map">
  ...
  <profileMarkerSymbol>
   <symbol is_animated="0" frame_rate="10" type="marker" alpha="1" clip_to_extent="1" force_rhr="0" name="">
    ...
    <layer enabled="1" pass="0" id="{aab30037-cfa3-4864-a998-d597725a8444}" locked="0" class="SimpleMarker">
     <Option type="Map">
 ...
 <renderer-v2 type="singleSymbol" enableorderby="0" referencescale="-1" forceraster="0" symbollevels="0">
  <symbols>
   <symbol is_animated="0" frame_rate="10" type="fill" alpha="0.7" clip_to_extent="1" force_rhr="0" name="0">
    <data_defined_properties>
     <Option type="Map">
      <Option type="QString" name="name" value=""/>
      <Option name="properties"/>
    ...
    <layer enabled="1" pass="0" id="{98aca98b-f2c2-4975-a503-e4081abd9ce9}" locked="0" class="SimpleFill">
     <Option type="Map">
      <Option type="QString" name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0"/>
      <Option type="QString" name="color" value="166,206,227,255,rgb:0.6509804,0.8078431,0.8901961,1"/>
      <Option type="QString" name="joinstyle" value="bevel"/>
      <Option type="QString" name="offset" value="0,0"/>
      <Option type="QString" name="offset_map_unit_scale" value="3x:0,0,0,0,0,0"/>
      <Option type="QString" name="offset_unit" value="MM"/>
 ...
 <selection mode="Default">
  ...
  <selectionSymbol>
   <symbol is_animated="0" frame_rate="10" type="fill" alpha="1" clip_to_extent="1" force_rhr="0" name="">
    ...
    <layer enabled="1" pass="0" id="{1bea37e2-efdc-4d0b-a185-b083f44d59ed}" locked="0" class="SimpleFill">
     <Option type="Map">
      <Option type="QString" name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0"/>
  ...
  <DiagramCategory backgroundColor="#ffffff" opacity="1" spacing="5" spacingUnit="MM" stackedDiagramSpacingUnitScale="3x:0,0,0,0,0,0" scaleBasedVisibility="0" labelPlacementMethod="XHeight" lineSizeScale="3x:0,0,0,0,0,0" direction="0" maxScaleDenominator="1e+08" sizeType="MM" enabled="0" minimumSize="0" penColor="#000000" diagramOrientation="Up" stackedDiagramMode="Horizontal" stackedDiagramSpacing="0" height="15" scaleDependency="Area" stackedDiagramSpacingUnit="MM" sizeScale="3x:0,0,0,0,0,0" rotationOffset="270" spacingUnitScale="3x:0,0,0,0,0,0" barWidth="5" showAxis="1" penAlpha="255" backgroundAlpha="255" lineSizeType="MM" minScaleDenominator="0" width="15" penWidth="0">
   ...
   <axisSymbol>
    <symbol is_animated="0" frame_rate="10" type="line" alpha="1" clip_to_extent="1" force_rhr="0" name="">
     ...
     <layer enabled="1" pass="0" id="{21ff9df9-e452-4a5c-a2c0-2da7d88c20a2}" locked="0" class="SimpleLine">
      <Option type="Map">
       <Option type="QString" name="align_dash_pattern" value="0"/>
       <Option type="QString" name="capstyle" value="square"/>
       <Option type="QString" name="customdash" value="5;2"/>
 ...
 <labelOnTop>
  <field name="affected_surveys" labelOnTop="0"/>
  <field name="appellation" labelOnTop="0"/>
  <field name="calc_area" labelOnTop="0"/>
  <field name="id" labelOnTop="0"/>
  <field name="land_district" labelOnTop="0"/>
  <field name="parcel_intent" labelOnTop="0"/>
  <field name="statutory_actions" labelOnTop="0"/>
  <field name="survey_area" labelOnTop="0"/>
  <field name="titles" labelOnTop="0"/>
  <field name="topology_type" labelOnTop="0"/>
 </labelOnTop>
 <previewExpression>"titles"</previewExpression>
