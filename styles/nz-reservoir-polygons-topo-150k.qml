...
<qgis minScale="75000" autoRefreshMode="Disabled" maxScale="0" labelsEnabled="0" simplifyDrawingHints="1" hasScaleBasedVisibilityFlag="1" version="3.44.8-Solothurn" autoRefreshTime="0" simplifyLocal="1" styleCategories="AllStyleCategories" simplifyDrawingTol="1" simplifyMaxScale="1" readOnly="0" symbologyReferenceScale="-1" simplifyAlgorithm="0">
 ...
 <elevation binding="Centroid" zoffset="0" zscale="1" clamping="Terrain" symbology="Line" extrusionEnabled="0" type="IndividualFeatures" customToleranceEnabled="0" extrusion="0" respectLayerSymbol="1" showMarkerSymbolInSurfacePlots="0">
  ...
  <profileLineSymbol>
   <symbol is_animated="0" frame_rate="10" type="line" alpha="1" clip_to_extent="1" force_rhr="0" name="">
    ...
    <layer enabled="1" pass="0" id="{334e09b3-787c-426c-bffd-52369a7ccd8d}" locked="0" class="SimpleLine">
     <Option type="Map">
  ...
  <profileFillSymbol>
   <symbol is_animated="0" frame_rate="10" type="fill" alpha="1" clip_to_extent="1" force_rhr="0" name="">
    ...
    <layer enabled="1" pass="0" id="{0029de54-82da-4b76-b5e9-9dae0c07ab67}" locked="0" class="SimpleFill">
     <Option type="Map">
  ...
  <profileMarkerSymbol>
   <symbol is_animated="0" frame_rate="10" type="marker" alpha="1" clip_to_extent="1" force_rhr="0" name="">
    ...
    <layer enabled="1" pass="0" id="{681d77e5-a125-43ef-98bf-c5e6cfd34c0d}" locked="0" class="SimpleMarker">
     <Option type="Map">
 ...
 <renderer-v2 type="RuleRenderer" enableorderby="0" referencescale="-1" forceraster="0" symbollevels="0">
  <rules key="{f9ad5426-8c9b-48a8-9ced-156d797a5f8b}">
   <rule filter=" &quot;lid_type&quot; = 'covered'" symbol="0" label="covered" key="{29d60a97-6d85-4ac7-8861-171c1054ed48}"/>
   <rule filter="ELSE" symbol="1" label="non-covered" key="{c4db6d24-67d4-412f-bb31-327ac715c4ca}"/>
  </rules>
  <symbols>
   <symbol is_animated="0" frame_rate="10" type="fill" alpha="0.2" clip_to_extent="1" force_rhr="0" name="0">
    ...
    <layer enabled="1" pass="0" id="{b1565043-4a82-484d-a74a-90524b636d00}" locked="0" class="SimpleFill">
     <Option type="Map">
      <Option type="QString" name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0"/>
 ...
 <selection mode="Default">
  ...
  <selectionSymbol>
   <symbol is_animated="0" frame_rate="10" type="fill" alpha="1" clip_to_extent="1" force_rhr="0" name="">
    ...
    <layer enabled="1" pass="0" id="{064a2e73-d98f-4a03-9e16-0eb5f3ad4261}" locked="0" class="SimpleFill">
     <Option type="Map">
      <Option type="QString" name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0"/>
      <Option type="QString" name="color" value="0,0,255,255,rgb:0,0,1,1"/>
      <Option type="QString" name="joinstyle" value="bevel"/>
 ...
 <labelOnTop>
  <field name="lid_type" labelOnTop="0"/>
  <field name="t50_fid" labelOnTop="0"/>
 </labelOnTop>
 <previewExpression>"lid_type"</previewExpression>
