...
<qgis minScale="10000" autoRefreshMode="Disabled" maxScale="0" labelsEnabled="1" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="1" version="3.44.8-Solothurn" autoRefreshTime="0" simplifyLocal="1" styleCategories="AllStyleCategories" simplifyDrawingTol="1" simplifyMaxScale="1" readOnly="0" symbologyReferenceScale="-1" simplifyAlgorithm="0">
 ...
 <elevation binding="Centroid" zoffset="0" zscale="1" clamping="Terrain" symbology="Line" extrusionEnabled="0" type="IndividualFeatures" customToleranceEnabled="0" extrusion="0" respectLayerSymbol="1" showMarkerSymbolInSurfacePlots="0">
  ...
  <profileLineSymbol>
   <symbol is_animated="0" frame_rate="10" type="line" alpha="1" clip_to_extent="1" force_rhr="0" name="">
    ...
    <layer enabled="1" pass="0" id="{c4ab6cb4-aa31-437a-baf4-33fdd9866b3d}" locked="0" class="SimpleLine">
     <Option type="Map">
  ...
  <profileFillSymbol>
   <symbol is_animated="0" frame_rate="10" type="fill" alpha="1" clip_to_extent="1" force_rhr="0" name="">
    ...
    <layer enabled="1" pass="0" id="{16fda8e7-78cf-4917-878d-06faef46d6fa}" locked="0" class="SimpleFill">
     <Option type="Map">
  ...
  <profileMarkerSymbol>
   <symbol is_animated="0" frame_rate="10" type="marker" alpha="1" clip_to_extent="1" force_rhr="0" name="">
    ...
    <layer enabled="1" pass="0" id="{86735033-6e50-49e0-a0aa-5f7a756d4cc0}" locked="0" class="SimpleMarker">
     <Option type="Map">
 ...
 <renderer-v2 type="singleSymbol" enableorderby="0" referencescale="-1" forceraster="0" symbollevels="0">
  <symbols>
   <symbol is_animated="0" frame_rate="10" type="marker" alpha="1" clip_to_extent="1" force_rhr="0" name="0">
    ...
    <layer enabled="1" pass="0" id="{e5b0e44f-4be3-49d2-b567-b61287d3510c}" locked="0" class="SimpleMarker">
     <Option type="Map">
      <Option type="QString" name="angle" value="0"/>
      <Option type="QString" name="cap_style" value="square"/>
 ...
 <selection mode="Default">
  ...
  <selectionSymbol>
   <symbol is_animated="0" frame_rate="10" type="marker" alpha="1" clip_to_extent="1" force_rhr="0" name="">
    ...
    <layer enabled="1" pass="0" id="{946498d0-9ea8-45e8-983b-14231a979793}" locked="0" class="SimpleMarker">
     <Option type="Map">
      <Option type="QString" name="angle" value="0"/>
      <Option type="QString" name="cap_style" value="square"/>
 ...
 <labeling type="simple">
  <settings calloutType="simple">
   ...
   <placement maxCurvedCharAngleIn="25" placementFlags="10" geometryGeneratorEnabled="0" repeatDistanceUnits="MM" maximumDistanceMapUnitScale="3x:0,0,0,0,0,0" yOffset="0" lineAnchorClipping="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" lineAnchorPercent="0.5" distUnits="MM" lineAnchorType="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" maximumDistanceUnit="MM" placement="1" priority="5" quadOffset="4" centroidInside="0" preserveRotation="1" repeatDistance="0" xOffset="0" overlapHandling="PreventOverlap" prioritization="PreferCloser" overrunDistanceUnit="MM" geometryGeneratorType="PointGeometry" lineAnchorTextPoint="FollowPlacement" offsetType="0" centroidWhole="0" offsetUnits="MM" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGenerator="" distMapUnitScale="3x:0,0,0,0,0,0" rotationAngle="0" polygonPlacementFlags="2" maxCurvedCharAngleOut="-25" rotationUnit="AngleDegrees" dist="0" fitInPolygonOnly="0" maximumDistance="0" allowDegraded="0" layerType="PointGeometry"/>
   <rendering limitNumLabels="0" scaleVisibility="0" upsidedownLabels="0" unplacedVisibility="0" fontLimitPixelSize="0" drawLabels="1" minFeatureSize="0" obstacleType="1" obstacleFactor="0" fontMinPixelSize="3" fontMaxPixelSize="10000" labelPerPart="0" mergeLines="0" scaleMax="0" zIndex="0" scaleMin="0" obstacle="0" maxNumLabels="2000"/>
   <dd_properties>
    <Option type="Map">
     <Option type="QString" name="name" value=""/>
     <Option name="properties"/>
 ...
 <labelOnTop>
  <field name="address_class" labelOnTop="0"/>
  <field name="address_id" labelOnTop="0"/>
  <field name="address_lifecycle" labelOnTop="0"/>
  <field name="address_number" labelOnTop="0"/>
  <field name="address_number_high" labelOnTop="0"/>
  <field name="address_number_prefix" labelOnTop="0"/>
  <field name="address_number_suffix" labelOnTop="0"/>
  <field name="change_id" labelOnTop="0"/>
  <field name="full_address" labelOnTop="0"/>
  <field name="full_address_ascii" labelOnTop="0"/>
  <field name="full_address_number" labelOnTop="0"/>
  <field name="full_road_name" labelOnTop="0"/>
  <field name="full_road_name_ascii" labelOnTop="0"/>
  <field name="gd2000_xcoord" labelOnTop="0"/>
  <field name="gd2000_ycoord" labelOnTop="0"/>
  <field name="is_land" labelOnTop="0"/>
  <field name="level_type" labelOnTop="0"/>
  <field name="level_value" labelOnTop="0"/>
  <field name="road_id" labelOnTop="0"/>
  <field name="road_name" labelOnTop="0"/>
  <field name="road_name_ascii" labelOnTop="0"/>
  <field name="road_name_prefix" labelOnTop="0"/>
  <field name="road_name_suffix" labelOnTop="0"/>
  <field name="road_name_type" labelOnTop="0"/>
  <field name="road_suffix" labelOnTop="0"/>
  <field name="road_type_name" labelOnTop="0"/>
  <field name="shape_X" labelOnTop="0"/>
  <field name="shape_Y" labelOnTop="0"/>
  <field name="source_dataset" labelOnTop="0"/>
  <field name="suburb_locality" labelOnTop="0"/>
  <field name="suburb_locality_ascii" labelOnTop="0"/>
  <field name="territorial_authority" labelOnTop="0"/>
  <field name="territorial_authority_ascii" labelOnTop="0"/>
  <field name="town_city" labelOnTop="0"/>
  <field name="town_city_ascii" labelOnTop="0"/>
  <field name="unit" labelOnTop="0"/>
  <field name="unit_type" labelOnTop="0"/>
  <field name="unit_value" labelOnTop="0"/>
  <field name="water_body_name" labelOnTop="0"/>
  <field name="water_body_name_ascii" labelOnTop="0"/>
  <field name="water_name" labelOnTop="0"/>
  <field name="water_name_ascii" labelOnTop="0"/>
 </labelOnTop>
 <previewExpression>"full_road_name"</previewExpression>
