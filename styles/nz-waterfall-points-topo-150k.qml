...
<qgis minScale="75000" autoRefreshMode="Disabled" maxScale="0" labelsEnabled="1" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="1" version="3.44.8-Solothurn" autoRefreshTime="0" simplifyLocal="1" styleCategories="AllStyleCategories" simplifyDrawingTol="1" simplifyMaxScale="1" readOnly="0" symbologyReferenceScale="-1" simplifyAlgorithm="0">
 ...
 <elevation binding="Centroid" zoffset="0" zscale="1" clamping="Terrain" symbology="Line" extrusionEnabled="0" type="IndividualFeatures" customToleranceEnabled="0" extrusion="0" respectLayerSymbol="1" showMarkerSymbolInSurfacePlots="0">
  ...
  <profileLineSymbol>
   <symbol is_animated="0" frame_rate="10" type="line" alpha="1" clip_to_extent="1" force_rhr="0" name="">
    ...
    <layer enabled="1" pass="0" id="{c9ea0af9-ecbf-4290-b6e4-1c3b9053fc02}" locked="0" class="SimpleLine">
     <Option type="Map">
  ...
  <profileFillSymbol>
   <symbol is_animated="0" frame_rate="10" type="fill" alpha="1" clip_to_extent="1" force_rhr="0" name="">
    ...
    <layer enabled="1" pass="0" id="{a7f141b7-7f54-4f58-893a-233aa0f5d107}" locked="0" class="SimpleFill">
     <Option type="Map">
  ...
  <profileMarkerSymbol>
   <symbol is_animated="0" frame_rate="10" type="marker" alpha="1" clip_to_extent="1" force_rhr="0" name="">
    ...
    <layer enabled="1" pass="0" id="{b92c7e09-afcd-4c42-a803-96203cebfb00}" locked="0" class="SimpleMarker">
     <Option type="Map">
 ...
 <renderer-v2 type="singleSymbol" enableorderby="0" referencescale="-1" forceraster="0" symbollevels="0">
  <symbols>
   <symbol is_animated="0" frame_rate="10" type="marker" alpha="1" clip_to_extent="1" force_rhr="0" name="0">
    ...
    <layer enabled="1" pass="0" id="{04f5bad6-9490-4fb2-80f3-514681e09e2b}" locked="0" class="SimpleMarker">
     <Option type="Map">
      <Option type="QString" name="angle" value="0"/>
      <Option type="QString" name="cap_style" value="square"/>
      ...
      <Option type="QString" name="offset_map_unit_scale" value="3x:0,0,0,0,0,0"/>
      <Option type="QString" name="offset_unit" value="MM"/>
      <Option type="QString" name="outline_color" value="31,120,180,255,rgb:0.1215686,0.4705882,0.7058824,1"/>
      <Option type="QString" name="outline_style" value="solid"/>
      <Option type="QString" name="outline_width" value="0.125"/>
      <Option type="QString" name="outline_width_map_unit_scale" value="3x:0,0,0,0,0,0"/>
      <Option type="QString" name="outline_width_unit" value="MM"/>
      <Option type="QString" name="scale_method" value="diameter"/>
      ...
      <Option type="Map">
       ...
       <Option type="Map" name="properties">
        <Option type="Map" name="angle">
         ...
         <Option type="QString" name="expression" value="if( orientatn &lt; 0, &#xa; degrees(orientatn * -1),&#xa; (180 - degrees(orientatn)))&#xa;"/>
         <Option type="Map" name="transformer">
          <Option type="Map" name="d">
           ...
           <Option type="double" name="maxValue" value="180"/>
           <Option type="double" name="minOutput" value="0"/>
           <Option type="double" name="minValue" value="-180"/>
    ...
    <layer enabled="1" pass="0" id="{c49abb8b-5e2c-494d-8482-8c1020b3c60d}" locked="0" class="SimpleMarker">
     <Option type="Map">
      <Option type="QString" name="angle" value="0"/>
      <Option type="QString" name="cap_style" value="square"/>
      <Option type="QString" name="color" value="255,0,0,255,rgb:1,0,0,1"/>
 ...
 <selection mode="Default">
  ...
  <selectionSymbol>
   <symbol is_animated="0" frame_rate="10" type="marker" alpha="1" clip_to_extent="1" force_rhr="0" name="">
    ...
    <layer enabled="1" pass="0" id="{c6720535-c31d-42d6-9f1e-c198c934ac0b}" locked="0" class="SimpleMarker">
     <Option type="Map">
      <Option type="QString" name="angle" value="0"/>
      <Option type="QString" name="cap_style" value="square"/>
      <Option type="QString" name="color" value="255,0,0,255,rgb:1,0,0,1"/>
 ...
 <labeling type="simple">
  <settings calloutType="simple">
   ...
   <placement maxCurvedCharAngleIn="25" placementFlags="10" geometryGeneratorEnabled="0" repeatDistanceUnits="MM" maximumDistanceMapUnitScale="3x:0,0,0,0,0,0" yOffset="2" lineAnchorClipping="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" lineAnchorPercent="0.5" distUnits="MM" lineAnchorType="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" maximumDistanceUnit="MM" placement="1" priority="5" quadOffset="8" centroidInside="0" preserveRotation="1" repeatDistance="0" xOffset="2" overlapHandling="PreventOverlap" prioritization="PreferCloser" overrunDistanceUnit="MM" geometryGeneratorType="PointGeometry" lineAnchorTextPoint="FollowPlacement" offsetType="1" centroidWhole="0" offsetUnits="MM" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGenerator="" distMapUnitScale="3x:0,0,0,0,0,0" rotationAngle="20" polygonPlacementFlags="2" maxCurvedCharAngleOut="-25" rotationUnit="AngleDegrees" dist="0" fitInPolygonOnly="0" maximumDistance="0" allowDegraded="0" layerType="PointGeometry"/>
   <rendering limitNumLabels="0" scaleVisibility="1" upsidedownLabels="0" unplacedVisibility="0" fontLimitPixelSize="0" drawLabels="1" minFeatureSize="0" obstacleType="1" obstacleFactor="1" fontMinPixelSize="3" fontMaxPixelSize="10000" labelPerPart="0" mergeLines="0" scaleMax="125000" zIndex="0" scaleMin="0" obstacle="1" maxNumLabels="2000"/>
   <dd_properties>
    <Option type="Map">
     <Option type="QString" name="name" value=""/>
     <Option name="properties"/>
 ...
 <labelOnTop>
  ...
  <field name="orientatn" labelOnTop="0"/>
