...
<qgis minScale="75000" autoRefreshMode="Disabled" maxScale="0" labelsEnabled="0" simplifyDrawingHints="1" hasScaleBasedVisibilityFlag="1" version="3.44.8-Solothurn" autoRefreshTime="0" simplifyLocal="1" styleCategories="AllStyleCategories" simplifyDrawingTol="1" simplifyMaxScale="1" readOnly="0" symbologyReferenceScale="-1" simplifyAlgorithm="0">
 ...
 <elevation binding="Centroid" zoffset="0" zscale="1" clamping="Terrain" symbology="Line" extrusionEnabled="0" type="IndividualFeatures" customToleranceEnabled="0" extrusion="0" respectLayerSymbol="1" showMarkerSymbolInSurfacePlots="0">
  ...
  <profileLineSymbol>
   <symbol is_animated="0" frame_rate="10" type="line" alpha="1" clip_to_extent="1" force_rhr="0" name="">
    ...
    <layer enabled="1" pass="0" id="{525c8386-fb3f-4e35-97ff-c684fe54af13}" locked="0" class="SimpleLine">
     <Option type="Map">
  ...
  <profileFillSymbol>
   <symbol is_animated="0" frame_rate="10" type="fill" alpha="1" clip_to_extent="1" force_rhr="0" name="">
    ...
    <layer enabled="1" pass="0" id="{2532a960-4b21-4cd8-a852-ba63e727d5e8}" locked="0" class="SimpleFill">
     <Option type="Map">
  ...
  <profileMarkerSymbol>
   <symbol is_animated="0" frame_rate="10" type="marker" alpha="1" clip_to_extent="1" force_rhr="0" name="">
    ...
    <layer enabled="1" pass="0" id="{d85b48ba-a63a-4a3f-af1a-4bf2b312eed4}" locked="0" class="SimpleMarker">
     <Option type="Map">
 ...
 <renderer-v2 type="RuleRenderer" enableorderby="0" referencescale="-1" forceraster="0" symbollevels="0">
  <rules key="{edbfb06c-dee3-4d69-9a12-3a1f3b6f0b18}">
   <rule filter=" &quot;species&quot;  = 'non-coniferous'" symbol="0" label="non-coniferous" key="{dd2255d2-86f5-4e06-877b-873b3e423718}"/>
   <rule filter="ELSE" symbol="1" label="coniferous" key="{f4f1648f-898c-474c-9447-d1343e33f767}"/>
  </rules>
  <symbols>
   <symbol is_animated="0" frame_rate="10" type="fill" alpha="0.2" clip_to_extent="1" force_rhr="0" name="0">
    <data_defined_properties>
     <Option type="Map">
      <Option type="QString" name="name" value=""/>
      <Option name="properties"/>
    ...
    <layer enabled="1" pass="0" id="{eb9be63a-42e6-499b-9ee8-1bce2562ddcd}" locked="0" class="SimpleFill">
     <Option type="Map">
      <Option type="QString" name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0"/>
      <Option type="QString" name="color" value="221,236,203,255,rgb:0.8666667,0.9254902,0.7960784,1"/>
      <Option type="QString" name="joinstyle" value="bevel"/>
      <Option type="QString" name="offset" value="0,0"/>
      <Option type="QString" name="offset_map_unit_scale" value="3x:0,0,0,0,0,0"/>
      <Option type="QString" name="offset_unit" value="MM"/>
      <Option type="QString" name="outline_color" value="170,213,159,255,rgb:0.6666667,0.8352941,0.6235294,1"/>
      <Option type="QString" name="outline_style" value="solid"/>
    ...
    <layer enabled="1" pass="0" id="{54ff15d1-d32f-4fa5-a8f0-fd003d3eb4e8}" locked="0" class="PointPatternFill">
     <Option type="Map">
      ...
      <Option type="QString" name="distance_y" value="3.6"/>
      ...
      <Option type="QString" name="seed" value="173441679"/>
     </Option>
     <data_defined_properties>
      <Option type="Map">
       <Option type="QString" name="name" value=""/>
     ...
     <symbol is_animated="0" frame_rate="10" type="marker" alpha="1" clip_to_extent="1" force_rhr="0" name="@0@1">
      ...
      <layer enabled="1" pass="0" id="{2abbeda9-2364-41a8-b271-4850bc963c91}" locked="0" class="RasterMarker">
       <Option type="Map">
        <Option type="QString" name="alpha" value="1"/>
        <Option type="QString" name="angle" value="0"/>
        <Option type="QString" name="fixedAspectRatio" value="1.8"/>
        <Option type="QString" name="horizontal_anchor_point" value="1"/>
        <Option type="QString" name="imageFile" value="{STYLE_IMAGES}forest - exotic nonconiferous.png"/>
        <Option type="QString" name="offset" value="0,0"/>
        <Option type="QString" name="offset_map_unit_scale" value="3x:0,0,0,0,0,0"/>
        <Option type="QString" name="offset_unit" value="MM"/>
        <Option type="QString" name="scale_method" value="diameter"/>
   ...
   <symbol is_animated="0" frame_rate="10" type="fill" alpha="0.2" clip_to_extent="1" force_rhr="0" name="1">
    <data_defined_properties>
     <Option type="Map">
      <Option type="QString" name="name" value=""/>
      <Option name="properties"/>
    ...
    <layer enabled="1" pass="0" id="{5b1e2d0f-b59b-49f6-8c86-79fab5bff74b}" locked="0" class="PointPatternFill">
     <Option type="Map">
      <Option type="double" name="angle" value="0"/>
      <Option type="QString" name="clip_mode" value="shape"/>
      <Option type="QString" name="coordinate_reference" value="feature"/>
      ...
      <Option type="QString" name="distance_x_map_unit_scale" value="3x:0,0,0,0,0,0"/>
      <Option type="QString" name="distance_x_unit" value="MM"/>
      <Option type="QString" name="distance_y" value="3.2"/>
      <Option type="QString" name="distance_y_map_unit_scale" value="3x:0,0,0,0,0,0"/>
      <Option type="QString" name="distance_y_unit" value="MM"/>
      <Option type="QString" name="offset_x" value="0"/>
      <Option type="QString" name="offset_x_map_unit_scale" value="3x:0,0,0,0,0,0"/>
      ...
      <Option type="QString" name="random_deviation_y_map_unit_scale" value="3x:0,0,0,0,0,0"/>
      <Option type="QString" name="random_deviation_y_unit" value="MM"/>
      <Option type="QString" name="seed" value="297518533"/>
     </Option>
     <data_defined_properties>
      <Option type="Map">
       <Option type="QString" name="name" value=""/>
     ...
     <symbol is_animated="0" frame_rate="10" type="marker" alpha="1" clip_to_extent="1" force_rhr="0" name="@1@1">
      <data_defined_properties>
       <Option type="Map">
        <Option type="QString" name="name" value=""/>
        <Option name="properties"/>
      ...
      <layer enabled="1" pass="0" id="{e18f0109-f8af-4673-89f1-7e2ef5e33360}" locked="0" class="RasterMarker">
       <Option type="Map">
        <Option type="QString" name="alpha" value="1"/>
        <Option type="QString" name="angle" value="0"/>
        <Option type="QString" name="fixedAspectRatio" value="1.06667"/>
        <Option type="QString" name="horizontal_anchor_point" value="1"/>
        <Option type="QString" name="imageFile" value="{STYLE_IMAGES}forest - exotic coniferous.png"/>
        <Option type="QString" name="offset" value="0,0"/>
        <Option type="QString" name="offset_map_unit_scale" value="3x:0,0,0,0,0,0"/>
        <Option type="QString" name="offset_unit" value="MM"/>
        <Option type="QString" name="scale_method" value="diameter"/>
 ...
 <selection mode="Default">
  ...
  <selectionSymbol>
   <symbol is_animated="0" frame_rate="10" type="fill" alpha="1" clip_to_extent="1" force_rhr="0" name="">
    ...
    <layer enabled="1" pass="0" id="{95b22123-edeb-4541-bc7d-d048cc654cb5}" locked="0" class="SimpleFill">
     <Option type="Map">
      <Option type="QString" name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0"/>
 ...
 <previewExpression>"species"</previewExpression>
