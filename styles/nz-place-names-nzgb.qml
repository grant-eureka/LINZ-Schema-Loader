...
<qgis minScale="250000" autoRefreshMode="Disabled" maxScale="0" labelsEnabled="1" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="1" version="3.44.8-Solothurn" autoRefreshTime="0" simplifyLocal="1" styleCategories="AllStyleCategories" simplifyDrawingTol="1" simplifyMaxScale="1" readOnly="0" symbologyReferenceScale="-1" simplifyAlgorithm="0">
 ...
 <elevation binding="Centroid" zoffset="0" zscale="1" clamping="Terrain" symbology="Line" extrusionEnabled="0" type="IndividualFeatures" customToleranceEnabled="0" extrusion="0" respectLayerSymbol="1" showMarkerSymbolInSurfacePlots="0">
  ...
  <profileLineSymbol>
   <symbol is_animated="0" frame_rate="10" type="line" alpha="1" clip_to_extent="1" force_rhr="0" name="">
    ...
    <layer enabled="1" pass="0" id="{98414266-dade-4e4a-b88a-461be4d78aa9}" locked="0" class="SimpleLine">
     <Option type="Map">
  ...
  <profileFillSymbol>
   <symbol is_animated="0" frame_rate="10" type="fill" alpha="1" clip_to_extent="1" force_rhr="0" name="">
    ...
    <layer enabled="1" pass="0" id="{8083466a-d478-49ab-8fcf-485172ffe42c}" locked="0" class="SimpleFill">
     <Option type="Map">
  ...
  <profileMarkerSymbol>
   <symbol is_animated="0" frame_rate="10" type="marker" alpha="1" clip_to_extent="1" force_rhr="0" name="">
    ...
    <layer enabled="1" pass="0" id="{379fc6a5-16ae-4a98-94d7-82acdf6dd127}" locked="0" class="SimpleMarker">
     <Option type="Map">
 ...
 <renderer-v2 type="singleSymbol" enableorderby="0" referencescale="-1" forceraster="0" symbollevels="0">
  <symbols>
   <symbol is_animated="0" frame_rate="10" type="marker" alpha="1" clip_to_extent="1" force_rhr="0" name="0">
    ...
    <layer enabled="1" pass="0" id="{40c8adb4-b51c-4ea8-a079-b24dd4c7bc4d}" locked="0" class="SimpleMarker">
     <Option type="Map">
      <Option type="QString" name="angle" value="0"/>
      <Option type="QString" name="cap_style" value="square"/>
      <Option type="QString" name="color" value="243,166,178,0,rgb:0.9529412,0.6509804,0.6980392,0"/>
      <Option type="QString" name="horizontal_anchor_point" value="1"/>
      <Option type="QString" name="joinstyle" value="bevel"/>
 ...
 <selection mode="Default">
  ...
  <selectionSymbol>
   <symbol is_animated="0" frame_rate="10" type="marker" alpha="1" clip_to_extent="1" force_rhr="0" name="">
    ...
    <layer enabled="1" pass="0" id="{3621c85f-54e7-420f-b2ee-233abed908b0}" locked="0" class="SimpleMarker">
     <Option type="Map">
      <Option type="QString" name="angle" value="0"/>
      <Option type="QString" name="cap_style" value="square"/>
 ...
 <labelOnTop>
  ...
  <field name="accuracy_r" labelOnTop="0"/>
  <field name="ant_pgaz_r" labelOnTop="0"/>
  <field name="ant_pn_ref" labelOnTop="0"/>
  <field name="conservanc" labelOnTop="0"/>
  <field name="cpa_legisl" labelOnTop="0"/>
  <field name="crd_datum" labelOnTop="0"/>
  <field name="crd_east" labelOnTop="0"/>
  <field name="crd_latitu" labelOnTop="0"/>
  <field name="crd_longit" labelOnTop="0"/>
  <field name="crd_north" labelOnTop="0"/>
  <field name="crd_projec" labelOnTop="0"/>
  <field name="desc_code" labelOnTop="0"/>
  <field name="doc_cons_u" labelOnTop="0"/>
  <field name="doc_gaz_re" labelOnTop="0"/>
  <field name="doc_gaz_su" labelOnTop="0"/>
  <field name="feat_id" labelOnTop="0"/>
  <field name="feat_note" labelOnTop="0"/>
  <field name="feat_type" labelOnTop="0"/>
  <field name="gebco" labelOnTop="0"/>
  <field name="geom_type" labelOnTop="0"/>
  <field name="height" labelOnTop="0"/>
  <field name="info_descr" labelOnTop="0"/>
  <field name="info_note" labelOnTop="0"/>
  <field name="info_origi" labelOnTop="0"/>
  <field name="info_ref" labelOnTop="0"/>
  <field name="label_hier" labelOnTop="0"/>
  <field name="land_distr" labelOnTop="0"/>
  <field name="maori_name" labelOnTop="0"/>
  <field name="name" labelOnTop="0"/>
  <field name="name_id" labelOnTop="0"/>
  <field name="nzgb_ref" labelOnTop="0"/>
  <field name="nzgb_sub_r" labelOnTop="0"/>
  <field name="region" labelOnTop="0"/>
  <field name="rev_gaz_re" labelOnTop="0"/>
  <field name="rev_gaz_su" labelOnTop="0"/>
  <field name="rev_treaty" labelOnTop="0"/>
  <field name="scar_id" labelOnTop="0"/>
  <field name="scar_rec_b" labelOnTop="0"/>
  <field name="scufn" labelOnTop="0"/>
  <field name="status" labelOnTop="0"/>
  <field name="treaty_leg" labelOnTop="0"/>
 </labelOnTop>
 <previewExpression>"name_id"</previewExpression>
