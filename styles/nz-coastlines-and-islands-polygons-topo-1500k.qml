...
<qgis minScale="50000000" autoRefreshMode="Disabled" maxScale="300000" labelsEnabled="0" simplifyDrawingHints="1" hasScaleBasedVisibilityFlag="1" version="3.44.8-Solothurn" autoRefreshTime="0" simplifyLocal="1" styleCategories="AllStyleCategories" simplifyDrawingTol="1" simplifyMaxScale="1" readOnly="0" symbologyReferenceScale="-1" simplifyAlgorithm="0">
 ...
 <elevation binding="Centroid" zoffset="0" zscale="1" clamping="Terrain" symbology="Line" extrusionEnabled="0" type="IndividualFeatures" customToleranceEnabled="0" extrusion="0" respectLayerSymbol="1" showMarkerSymbolInSurfacePlots="0">
  ...
  <profileLineSymbol>
   <symbol is_animated="0" frame_rate="10" type="line" alpha="1" clip_to_extent="1" force_rhr="0" name="">
    ...
    <layer enabled="1" pass="0" id="{01fb3113-1daf-4fce-980c-a42c90d508bf}" locked="0" class="SimpleLine">
     <Option type="Map">
  ...
  <profileFillSymbol>
   <symbol is_animated="0" frame_rate="10" type="fill" alpha="1" clip_to_extent="1" force_rhr="0" name="">
    ...
    <layer enabled="1" pass="0" id="{d0d4de42-037b-46e4-9ac1-c17f1d5d136b}" locked="0" class="SimpleFill">
     <Option type="Map">
  ...
  <profileMarkerSymbol>
   <symbol is_animated="0" frame_rate="10" type="marker" alpha="1" clip_to_extent="1" force_rhr="0" name="">
    ...
    <layer enabled="1" pass="0" id="{5bce893e-7f6d-47a0-baeb-1b41824f2c4d}" locked="0" class="SimpleMarker">
     <Option type="Map">
 ...
 <renderer-v2 type="singleSymbol" enableorderby="0" referencescale="-1" forceraster="0" symbollevels="0">
  <symbols>
   <symbol is_animated="0" frame_rate="10" type="fill" alpha="1" clip_to_extent="1" force_rhr="0" name="0">
    ...
    <layer enabled="1" pass="0" id="{0ca2e792-ddd1-4a7b-81a2-32cfc54cdc55}" locked="0" class="SimpleFill">
     <Option type="Map">
      <Option type="QString" name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0"/>
 ...
 <selection mode="Default">
  ...
  <selectionSymbol>
   <symbol is_animated="0" frame_rate="10" type="fill" alpha="1" clip_to_extent="1" force_rhr="0" name="">
    ...
    <layer enabled="1" pass="0" id="{be2d7bb5-e7ac-4721-841e-9b8dc5cfefa9}" locked="0" class="SimpleFill">
     <Option type="Map">
      <Option type="QString" name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0"/>
 ...
 <labeling type="simple">
  <settings calloutType="simple">
   ...
   <rendering limitNumLabels="0" scaleVisibility="1" upsidedownLabels="0" unplacedVisibility="0" fontLimitPixelSize="0" drawLabels="1" minFeatureSize="0" obstacleType="1" obstacleFactor="1" fontMinPixelSize="3" fontMaxPixelSize="10000" labelPerPart="0" mergeLines="0" scaleMax="0" zIndex="0" scaleMin="1000000" obstacle="1" maxNumLabels="2000"/>
   <dd_properties>
    <Option type="Map">
     <Option type="QString" name="name" value=""/>
     <Option name="properties"/>
 ...
 <labelOnTop>
  <field name="group_name" labelOnTop="0"/>
  <field name="name" labelOnTop="0"/>
 </labelOnTop>
 <previewExpression>"group_name"</previewExpression>
